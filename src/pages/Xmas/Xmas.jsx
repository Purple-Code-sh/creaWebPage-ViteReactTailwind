    ...
    <div className='p-0 m-0 pt-14'>
      <div>
        <section className='w-screen'>
          <main className=' bg-gradient-to-b from-black to-bg_accent_dark/60'>
          ...
          <div className='xl:pt-28 pt-16 md:pt-20 cursor-default bg-gradient-to-b from-bg_accent_dark/60 to-black'>
            <div className='container mx-auto px-4'>

              <p className='font-bold text-lg text-white/75  text-center md:text-xl lg:text-2xl mx-auto px-8'>
                Las categorías en las que se realizarán las competencias son las siguientes:
              </p>

              <ul className='font-normal mx-auto pt-6 text-txt_white_purple'>
                {categoriesArray.map((item, key) => {
                  return (
                    <li key={key} className=' hover:text-primary text-center w-fit mx-auto active:text-secondary'>
                      <Link to={`${item.link}`}>
                        {item.name}
                      </Link>
                    </li>
      ...
      <div className='container mx-auto px-4 flex flex-col justify-center my-16'>
        {/* Mapa agregado aquí */}
